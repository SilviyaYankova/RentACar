...
public class CommentDialog {
    ...
    public CommentDialog(UserService userService, CarService carService, CommentService commentService) {
    ...
    public void input(User LOGGED_IN_USER) throws InvalidEntityDataException, NoneExistingEntityException {
        ...
        while (continueCommenting) {
            if (cars.size() > 0) {
                ...
                Comment comment = addCommentDialog.init(LOGGED_IN_USER, car);
