...
public class EditSellerDialog {
    Scanner scanner = new Scanner(System.in);
    private final UserService userService;
    User LOGGED_IN_USER;

    public EditSellerDialog(UserService userService, User LOGGED_IN_USER) {
    ...
    public void input(User LOGGED_IN_USER) throws NoneExistingEntityException {
        ...
        if (all.size() > 0) {
            ...
            System.out.println("Choose a seller to edit from the list above .");
